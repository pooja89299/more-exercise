...
# Apne simple se message ko aise change karna jisse koi dusra insaan
#  usse samajh na paye usse encryption bolte hai.
#   Encryption karne ke bhot sare ways hote hai.
#    Hum cipher wheel use karenge. Cipher wheel
#     mei hum her character ko kissi number se aage 
#     shift kar dete hai. Jaise: Hum iss cihper wheel
#      mein her character ki value ko 2 se increase kar denge.
#       Aisa karne ke liye hum chars aur shifted_chars array 
